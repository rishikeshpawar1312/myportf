  ...
  const experiences: ExperienceItem[] = [
    {
      ...
      description: [
        ...
        "Implementing responsive and efficient front-end interfaces",
  ...
  return (
    <section className="py-16 bg-white min-h-screen flex items-center justify-center">
      <div className="container mx-auto px-4 max-w-6xl">
        <motion.h2
          className="text-3xl md:text-4xl font-bold text-center text-black mb-12 md:mb-16"
        ...
        <div className="relative">
          ...
          {experiences.map((exp, index) => (
            <motion.div
              key={index}
              className={`
                flex flex-col md:flex-row items-center mb-12 md:mb-16 relative 
            ...
            >
              ...
              <div
                className={`
                  w-full md:w-1/2 bg-black text-white border-gray-800 rounded-xl p-6 mt-4 md:mt-0
              ...
              >
                ...
                {exp.description.map((point, pointIndex) => (
                  <p key={pointIndex} className="text-sm md:text-base text-gray-400 mb-2">
                    • {point}
                  </p>
                ))}
  
                {exp.isIntern && (
                  <div className="mt-4 text-xs md:text-sm italic text-green-400">
